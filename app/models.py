...
class InfluxIntegrationConfig(db.Model):
    ...
    temperature_homeassistant_entity_id = db.Column(db.String(255))
    temperature_influx_measurement = db.Column(db.String(255))
    temperature_influx_field = db.Column(db.String(255))
    temperature_influx_tags = db.Column(db.Text)
    rainfall_homeassistant_entity_id = db.Column(db.String(255))
    rainfall_influx_measurement = db.Column(db.String(255))
    rainfall_influx_field = db.Column(db.String(255))
    rainfall_influx_tags = db.Column(db.Text)
