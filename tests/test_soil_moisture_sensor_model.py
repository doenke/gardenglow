...
class SoilMoistureSensorModelTest(unittest.TestCase):
    ...
    def test_sensor_pages_render_forms_and_location_action(self):
        ...
        self.assertNotIn('/sensors?location_id={}'.format(self.location_id), location_response.get_data(as_text=True))
        self.assertNotIn('Sensor verknüpfen', location_response.get_data(as_text=True))
    ...
    def test_location_detail_hides_soil_moisture_without_linked_sensor(self):
        ...
        self.assertNotIn('/sensors?location_id={}'.format(self.location_id), html)
        self.assertNotIn('Zur Sensorseite dieses Beets', html)
        self.assertNotIn('Sensor verknüpfen', html)
        self.assertNotIn('Bodenfeuchte-Sensor anlegen</a>', html)
    ...
    def test_location_detail_renders_soil_moisture_series_for_linked_sensors(self):
        ...
        self.assertIn('/locations/{}'.format(self.location_id), html)
        self.assertIn('Zur allgemeinen Beetseite', html)
        self.assertNotIn('/sensors?location_id={}'.format(self.location_id), html)
        self.assertNotIn('Zur Sensorseite dieses Beets', html)
